...
def test_mcp_advertises_safe_v4_v5_surface(tmp_path: Path):
    ...
    assert responses[0]["result"]["serverInfo"]["version"]=="5.2.0"
    assert {"v4_status","v4_experiment_submit","v4_shadow_rebalance","v4_manual_action_validate"}<=names
    assert {"v5_today","v5_program_create","v5_opportunity_transition","v5_action_card","v5_program_metrics_calculate","v5_scorecard_publish","wake_claim","wake_complete","v4_manifest_get","v5_quant_research_status","v5_quant_experiment_status","v5_quant_scan_get","v5_quant_review_get"}<=names
