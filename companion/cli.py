...
def parser() -> argparse.ArgumentParser:
    ...
    dispatch=sub.add_parser("dispatch");dispatch.add_argument("--dry-run",action="store_true");dispatch.add_argument("--limit",type=int,default=3)
...
def main(argv=None) -> int:
    ...
    try:
        if a.command=="init":result=c.initialize()
            ...
            elif a.command=="backup":result={"path":str(c.db.backup(a.destination))}
